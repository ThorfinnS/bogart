...
-- Spawn
mobs:spawn_specific("mobs_mc:wolf", mobs_mc.spawn.wolf, {"air"}, 0, minetest.LIGHT_MAX+1, 30, 35000, 20, mobs_mc.spawn_height.water+3, mobs_mc.spawn_height.overworld_max)
