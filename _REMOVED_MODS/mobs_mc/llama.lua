...
--spawn
mobs:spawn_specific("mobs_mc:llama", mobs_mc.spawn.savanna, {"air"}, 0, minetest.LIGHT_MAX+1, 30, 35000, 5, mobs_mc.spawn_height.water+15, mobs_mc.spawn_height.overworld_max)
