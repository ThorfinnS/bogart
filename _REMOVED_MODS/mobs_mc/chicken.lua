...
--spawn
mobs:spawn_specific("mobs_mc:chicken", mobs_mc.spawn.grassland, {"air"}, 9, minetest.LIGHT_MAX+1, 30, 25000, 3, mobs_mc.spawn_height.overworld_min, mobs_mc.spawn_height.overworld_max)
