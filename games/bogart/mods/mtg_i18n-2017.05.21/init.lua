...
desc("binoculars:binoculars", S("Binoculars\nUse with 'Zoom' key"))
...
desc("default:acacia_leaves", S("Acacia Tree Leaves"))
...
desc("default:aspen_leaves", S("Aspen Tree Leaves"))
...
desc("default:blueberries", S("Blueberries"))
...
desc("default:coral_green", S("Green Coral"))
desc("default:coral_pink", S("Pink Coral"))
desc("default:coral_cyan", S("Cyan Coral"))
...
desc("default:fence_acacia_wood", S("Acacia Wood Fence"))
desc("default:fence_aspen_wood", S("Aspen Wood Fence"))
desc("default:fence_junglewood", S("Jungle Wood Fence"))
desc("default:fence_pine_wood", S("Pine Wood Fence"))
desc("default:fence_wood", S("Apple Wood Fence"))
desc("default:fern_1", S("Helecho"))
desc("default:fern_2", S("Helecho"))
desc("default:fern_3", S("Helecho"))
...
desc("default:jungleleaves", S("Jungle Tree Leaves"))
desc("default:junglesapling", S("Jungle Tree Sapling"))
desc("default:jungletree", S("Jungle Tree"))
desc("default:junglewood", S("Jungle Wood Planks"))
...
desc("default:leaves", S("Apple Tree Leaves"))
desc("default:marram_grass_1", S("Carrizo"))
desc("default:marram_grass_2", S("Carrizo"))
desc("default:marram_grass_3", S("Carrizo"))
...
desc("default:pine_sapling", S("Pine Tree Sapling"))
...
desc("default:sand_with_kelp", S("Kelp"))
desc("default:sapling", S("Apple Tree Sapling"))
...
desc("doors:gate_acacia_wood_closed", S("Acacia Wood Fence Gate"))
desc("doors:gate_acacia_wood_open", S("Acacia Wood Fence Gate"))
desc("doors:gate_aspen_wood_closed", S("Aspen Wood Fence Gate"))
desc("doors:gate_aspen_wood_open", S("Aspen Wood Fence Gate"))
desc("doors:gate_junglewood_closed", S("Jungle Wood Fence Gate"))
desc("doors:gate_junglewood_open", S("Jungle Wood Fence Gate"))
desc("doors:gate_pine_wood_closed", S("Pine Wood Fence Gate"))
desc("doors:gate_pine_wood_open", S("Pine Wood Fence Gate"))
desc("doors:gate_wood_closed", S("Apple Wood Fence Gate"))
desc("doors:gate_wood_open", S("Apple Wood Fence Gate"))
desc("doors:hidden", S("Hidden Door Segment"))
desc("doors:trapdoor_open", S("Wooden Trapdoor"))
desc("doors:trapdoor_steel_open", S("Steel Trapdoor"))
desc("doors:trapdoor_steel", S("Steel Trapdoor"))
desc("doors:trapdoor", S("Wooden Trapdoor"))
...
desc("flowers:chrysanthemum_green", S("Green Chrysanthemum"))
...
desc("flowers:rose", S("Red Rose"))
desc("flowers:tulip", S("Orange Tulip"))
desc("flowers:tulip_black", S("Black Tulip"))
...
desc("vessels:drinking_glass", S("Empty Drinking Glass"))
desc("vessels:glass_bottle", S("Empty Glass Bottle"))
desc("vessels:glass_fragments", S("Glass Fragments"))
desc("vessels:shelf", S("Vessels Shelf"))
desc("vessels:steel_bottle", S("Empty Heavy Steel Bottle"))
