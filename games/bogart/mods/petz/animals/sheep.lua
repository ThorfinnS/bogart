...
minetest.register_node("zmobs:sheep_block", {
	drawtype = "nodebox",
	node_box = {
		type = "fixed",
		fixed = {
	...
	tiles = {"zmobs_sheep_top.png", "zmobs_sheep_bottom.png", "zmobs_sheep_right_side.png",
    "zmobs_sheep_left_side.png", "zmobs_sheep_front.png", "zmobs_sheep_back.png"},
    groups = {not_in_creative_inventory = 1},
})

minetest.register_node("zmobs:sheep_shaved", {
	drawtype = "nodebox",
	node_box = {
		type = "fixed",
		fixed = {
	...
	tiles = {"zmobs_sheep_shaved_top.png", "zmobs_sheep_bottom.png", "zmobs_sheep_shaved_right_side.png",
    "zmobs_sheep_shaved_left_side.png", "zmobs_sheep_shaved_front.png", "zmobs_sheep_shaved_back.png"},
    groups = {not_in_creative_inventory = 1},
})


mobs:register_mob("zmobs:sheep", {
	type = "animal",
	passive = true,
    hp_min = 4,
    hp_max = 8,
	...
	textures = {"zmobs:sheep_block"},
    --gotten_texture = {"zmobs:sheep_shaved"},
    ...
    tool = clicker:get_wielded_item():get_name()
        ...
        if zmobs:capture_mob(self, clicker, "zmobs:sheep") then return end

    
		if tool == "mobs:shears" and clicker:get_inventory() and not self.empty then
			self.empty = true
			clicker:get_inventory():add_item("main", "wool:white")
            minetest.sound_play("zmobs_sheep_hurt",{pos=pos, max_hear_distance=3, gain=0.5, loop=false})
			self.object:set_properties({
				textures = {"zmobs:sheep_shaved"},
			})
		end
    end
    })
