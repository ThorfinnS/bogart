...
minetest.register_node("cherrytree:creeper", {
	description = S("Cherrytree Creeper"),
	drawtype = "nodebox",
	walkable = true,
	paramtype = "light",
	paramtype2 = "facedir",
	tiles = {"cherrytree_creeper.png"},
	inventory_image = "cherrytree_creeper.png",
	wield_image = "cherrytree_creeper.png",
	node_box = {
		type = "fixed",
...
minetest.register_node("cherrytree:flower_creeper", {
	description = S("Cherrytree Flower Creeper"),
	drawtype = "nodebox",
	walkable = true,
	paramtype = "light",
	paramtype2 = "facedir",
	tiles = {"cherrytree_flower_creeper.png"},
	inventory_image = "cherrytree_flower_creeper.png",
	wield_image = "cherrytree_flower_creeper.png",
	node_box = {
		type = "fixed",
		fixed = {-0.5, -0.5, 0.49, 0.5, 0.5, 0.5}
	},
...
minetest.register_node("cherrytree:hanging_creeper", {
	description = S("Cherrytree Hanging Creeper"),
	drawtype = "nodebox",
	walkable = true,
	paramtype = "light",
	paramtype2 = "facedir",
	tiles = {"cherrytree_hanging_creeper.png"},
	inventory_image = "cherrytree_hanging_creeper.png",
	wield_image = "cherrytree_hanging_creeper.png",
	node_box = {
		type = "fixed",
