...
minetest.register_node("kmobs:kitty_block", {
	drawtype = "nodebox",
	node_box = {
		type = "fixed",
		fixed = {
	...
	tiles = {
		"kmobs_kitty_top.png",
		"kmobs_kitty_bottom.png",
		"kmobs_kitty_right.png",
		"kmobs_kitty_left.png",
		"kmobs_kitty_back.png",
		"kmobs_kitty_front.png"
	},
	paramtype = "light",
    groups = {not_in_creative_inventory = 1},
})

mobs:register_mob("kmobs:kitty", {
	type = "animal",
	rotate = 180,
	damage = 8,
    hp_min = 4,
