...
mobs:spawn_specific("mobs_mc:pig", mobs_mc.spawn.grassland, {"air"}, 9, minetest.LIGHT_MAX+1, 30, 25000, 30, mobs_mc.spawn_height.overworld_min, mobs_mc.spawn_height.overworld_max)
