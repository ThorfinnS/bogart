...
minetest.register_node("pets:lamb_block", {
	tiles = {
		"pets_lamb_top.png",
		"pets_lamb_bottom.png",
		"pets_lamb_right.png",
		"pets_lamb_left.png",
		"pets_lamb_back.png",
		"pets_lamb_front.png"
...
minetest.register_node("pets:lamb_shaved", {
	drawtype = "nodebox",
	node_box = {
		type = "fixed",
		fixed = {
	...
	tiles = {
		"pets_lamb_shaved_top.png",
		"pets_lamb_shaved_bottom.png",
		"pets_lamb_shaved_right.png",
		"pets_lamb_shaved_left.png",
		"pets_lamb_shaved_back.png",
		"pets_lamb_shaved_front.png"
	},
    groups = {not_in_creative_inventory = 1},
})


mobs:register_mob("pets:lamb", {
	type = "animal",
	passive = true,
    hp_min = 4,
    hp_max = 8,
	...
	textures = {"pets:lamb_block"},	
    --gotten_texture = {"pets:lamb_shaved"},
    rotate = 180,
    ...
    tool = clicker:get_wielded_item():get_name()
        ...
        if mobs:capture_mob(self, clicker, "pets:lamb") then return end

    
		if tool == "mobs:shears" and clicker:get_inventory() and not self.empty then
			self.empty = true
			clicker:get_inventory():add_item("main", "wool:white")
            minetest.sound_play("pets_lamb_hurt",{pos=pos, max_hear_distance=3, gain=0.5, loop=false})
			self.object:set_properties({
				textures = {"pets:lamb_shaved"},
			})
		end
    end
    })
