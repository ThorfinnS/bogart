...
local tiles2 = {
		"pets_calf2_top.png",
		"pets_calf2_bottom.png",
		"pets_calf2_right.png",
		"pets_calf2_left.png",
		"pets_calf2_back.png",
		"pets_calf2_front.png"
	}
...
minetest.register_node("pets:calf_block", {
	tiles =tiles,
	drawtype = "nodebox",
	paramtype = "light",
	node_box = {
...
minetest.register_node("pets:calf_block2", {
	tiles =tiles2,
	drawtype = "nodebox",
	paramtype = "light",
	node_box = {
...
mobs:register_mob("pets:calf", {
	...
	hp_max = 20,
	armor = 200,
	collisionbox = {-0.25, -1.87, -0.25, 0.25, -0.25, 0.25},
	visual = "wielditem",
	visual_size = {x = 2.5, y = 2.5},
	rotate = 180,
	textures = {{"pets:calf_block2"}, {"pets:calf_block"}},
	...
	on_rightclick = function(self, clicker)
    	...
    	if tool:get_name() == "bucket:bucket_empty" then        
        	...
        	if self.gotten == true then
            	minetest.sound_play("pets_calfy",{pos=pos, max_hear_distance=3, gain=0.5, loop=false})
            	return
        	end
        	local inv = clicker:get_inventory()
        	tool:take_item()
        	clicker:set_wielded_item(tool)
        	if inv:room_for_item("main", {name = "pets:bucket_milk"}) then
            	clicker:get_inventory():add_item("main", "pets:bucket_milk")
        	else
            	local pos = self.object:get_pos()
            	pos.y = pos.y + 0.5
            	minetest.add_item(pos, {name = "pets:bucket_milk"})
        	end
