...
minetest.register_node("pets:panda_block", {
	tiles = {
		"pets_panda_top.png",
		"pets_panda_bottom.png",
		"pets_panda_right.png",
		"pets_panda_left.png",
		"pets_panda_back.png",
		"pets_panda_front.png"
	},
	drawtype = "nodebox",
	paramtype = "light",
	node_box = {
