...
--DUCKY
--
minetest.register_node("pets:ducky_block", {
	tiles = {
		"pets_ducky_top.png",
		"pets_ducky_bottom.png",
		"pets_ducky_right.png",
		"pets_ducky_left.png",
		"pets_ducky_back.png",
		"pets_ducky_front.png"
	},
	drawtype = "nodebox",
	paramtype = "light",
	paramtype2 = "facedir",
