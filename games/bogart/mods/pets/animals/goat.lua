...
minetest.register_node("zmobs:goat_block", {
	drawtype = "nodebox",
	node_box = {
		type = "fixed",
		fixed = {
	...
	tiles = {"zmobs_goat_top.png", "zmobs_goat_bottom.png", "zmobs_goat_right_side.png",
    "zmobs_goat_left_side.png", "zmobs_goat_front.png", "zmobs_goat_back.png"},
    groups = {not_in_creative_inventory = 1},
})



mobs:register_mob("zmobs:goat", {
	type = "animal",
	passive = false,
    ...
    if zmobs:capture_mob(self, clicker, "zmobs:goat") then return end
