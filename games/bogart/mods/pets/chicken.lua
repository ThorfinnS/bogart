...
--CHICKEN
--
minetest.register_node("pets:chicken_block", {
	tiles = {
		"pets_chicken_top.png",
		"pets_chicken_bottom.png",
		"pets_chicken_right.png",
		"pets_chicken_left.png",
		"pets_chicken_back.png",
		"pets_chicken_front.png"
	},
	drawtype = "nodebox",
	paramtype = "light",
	paramtype2 = "facedir",
...
mobs:register_mob("pets:chicken", {
	type = "animal",
	rotate = 180,
	damage = 8,
    hp_min = 4,
