...
minetest.register_node("pets:piggy_block", {
	tiles = {
		"pets_piggy_top.png",
		"pets_piggy_bottom.png",
		"pets_piggy_right.png",
		"pets_piggy_left.png",
		"pets_piggy_back.png",
		"pets_piggy_front.png"
	},
	drawtype = "nodebox",
	paramtype = "light",
	node_box = {
...
-- raw porkchop
minetest.register_craftitem("pets:pork_raw", {
	description = "Raw Porkchop",
	inventory_image = "pets_pork_raw.png",
	on_use = minetest.item_eat(4),
})

-- cooked porkchop
minetest.register_craftitem("pets:pork_cooked", {
	description = "Cooked Porkchop",
	inventory_image = "pets_pork_cooked.png",
	on_use = minetest.item_eat(8),
})

minetest.register_craft({
	type = "cooking",
	output = "pets:pork_cooked",
	recipe = "pets:pork_raw",
	cooktime = 5,
})
